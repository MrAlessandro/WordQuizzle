...
/*        UsersManager Net = UsersManager.getNet();
        ...
        // Put some server.users and their friendships
        /*
        {
            Net.registerUser("Andrea", password);
            Net.registerUser("Giacomo", password);
            Net.registerUser("Alessandro", password);
            Net.registerUser("Paola", password);
            Net.registerUser("Claudia", password);
            Net.registerUser("Stefano", password);
            Net.registerUser("Beatrice", password);
            Net.registerUser("Chiara", password);
